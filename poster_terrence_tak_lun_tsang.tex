		...
		\begin{column}{0.32\linewidth}
			...
			\begin{columns}[onlytextwidth]
				\begin{column}{0.45\textwidth}
					...
					The amplitude spectral density of the super sensor noise from $\mathcal{H}_\infty$ filters are on par, if not lower, compared to the other two below $0.4\,\text{Hz}$ but is slightly higher at higher frequencies.
